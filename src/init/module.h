...
#ifndef __LANE_MODULE_H__
#define __LANE_MODULE_H__
...
public:
    ...
    virtual bool onConnect(lane::Stream::ptr stream);
    virtual bool onDisconnect(lane::Stream::ptr stream);
...
typedef lane::Singleton<ModuleManager> ModuleMgr;
