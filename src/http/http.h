...
#ifndef __LANE_HTTP_H__
#define __LANE_HTTP_H__
...
#undef XX
        ...
        class HttpRequest {
           public:
             ...
             */
            template <class T>
            bool checkGetHeaderAs(const std::string& key,
                                  T& val,
                                  const T& def = T()) {
             ...
             */
            template <class T>
            bool checkGetParamAs(const std::string& key,
                                 T& val,
                                 const T& def = T()) {
                initQueryParam();
                initBodyParam();
             ...
             */
            template <class T>
            bool checkGetCookieAs(const std::string& key,
                                  T& val,
                                  const T& def = T()) {
                initCookies();
