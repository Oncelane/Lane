...
#ifndef __LANE_SERVLET_H__
#define __LANE_SERVLET_H__
    ...
    namespace http {
        ...
        class Servlet {
           public:
             ...
             * @return 是否处理成功
             */
            virtual int32_t handle(lane::http::HttpRequest::ptr request,
                                   lane::http::HttpResponse::ptr response,
                                   lane::http::HttpSession::ptr session) = 0;
        ...
        class FunctionServlet : public Servlet {
           public:
            ...
            typedef std::function<int32_t(
                lane::http::HttpRequest::ptr request,
                lane::http::HttpResponse::ptr response,
            ...
            virtual int32_t handle(
                lane::http::HttpRequest::ptr request,
                lane::http::HttpResponse::ptr response,
                lane::http::HttpSession::ptr session) override;
        ...
        class ServletDispatch : public Servlet {
           public:
            ...
            template <class T>
            void addGlobServletCreator(const std::string& uri) {
                addGlobServletCreator(uri,
                                      std::make_shared<ServletCreator<T> >());
            }
